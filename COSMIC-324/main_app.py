...
# ============================================================
# 🌍 قائمة الدول الكاملة (مع خيار البحث)
# ============================================================
try:
    import pycountry
    ...
    countries = [
        ...
        "عُمان", "الجزائر", "المغرب", "تونس", "ليبيا", "موريتانيا", "الصومال",
        "جيبوتي", "جزر القمر", "الولايات المتحدة", "كندا", "المملكة المتحدة",
        "فرنسا", "ألمانيا", "إيطاليا", "إسبانيا", "البرتغال", "هولندا",
        "بلجيكا", "سويسرا", "النمسا", "السويد", "النرويج", "الدنمارك",
        "فنلندا", "روسيا", "الصين", "اليابان", "كوريا الجنوبية", "الهند",
        "باكستان", "بنغلاديش", "إندونيسيا", "ماليزيا", "سنغافورة", "أستراليا",
        "نيوزيلندا", "جنوب أفريقيا", "نيجيريا", "كينيا", "غانا", "البرازيل",
        "الأرجنتين", "المكسيك", "تشيلي", "كولومبيا", "فنزويلا"
    ]
