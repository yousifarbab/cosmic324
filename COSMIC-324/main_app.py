...
LANGUAGES = {
    ...
    "fr": {
        ...
        "celestrak": "📡 Données Celestrak",
        "group": "Groupe",
        "alert_latency": "⚠️ Latence élevée!",
        "alert_satellites": "⚠️ Peu de satellites actifs!",
        "alert_threshold": "Seuil d'alerte (ms)",
        "active_threshold": "Min. satellites actifs",
        "3d_globe": "🌍 Globe 3D",
        "pricing": "💰 Tarifs",
        "coverage": "📡 Carte de couverture",
        "spectrum": "📶 Analyseur 6G",
        "j2_effect": "🌀 Effet J2",
    ...
    "de": {
        ...
        "welcome": "🌟 Willkommen bei COSMIC-324.",
        "params": "⚙️ Parameter",
        "sat_count": "Anzahl Satelliten",
        ...
        "max_alt": "Max. Höhe",
        "min_alt": "Min. Höhe",
        "celestrak": "📡 Celestrak-Daten",
        "group": "Gruppe",
        "alert_latency": "⚠️ Hohe Latenz!",
        "alert_satellites": "⚠️ Wenig aktive Satelliten!",
        "alert_threshold": "Warngrenze (ms)",
        "active_threshold": "Min. aktive Satelliten",
        "3d_globe": "🌍 3D-Globus",
        "pricing": "💰 Preise",
        "coverage": "📡 Abdeckung",
        "spectrum": "📶 6G-Spektrum",
        "j2_effect": "🌀 J2-Effekt",
        "propulsion": "🚀 Antrieb",
    ...
    "es": {
        ...
        "longitude": "Longitud",
        "altitude": "Altitud (km)",
        "latency_chart": "📈 Evolución de latencia",
        "step": "Paso",
        ...
        "celestrak": "📡 Datos Celestrak",
        "group": "Grupo",
        "alert_latency": "⚠️ Latencia alta!",
        "alert_satellites": "⚠️ Pocos satélites activos!",
        "alert_threshold": "Umbral (ms)",
        "active_threshold": "Mín. satélites activos",
        "3d_globe": "🌍 Globo 3D",
        "pricing": "💰 Planes",
        "coverage": "📡 Cobertura",
        "spectrum": "📶 Analizador 6G",
        "j2_effect": "🌀 Efecto J2",
    ...
    "zh": {
        ...
        "max_alt": "最大高度",
        "min_alt": "最小高度",
        "celestrak": "📡 Celestrak数据",
        "group": "星群",
        "alert_latency": "⚠️ 高延迟！",
        "alert_satellites": "⚠️ 活跃卫星数量低！",
    ...
    "ru": {
        ...
        "welcome": "🌟 Добро пожаловать в COSMIC-324.",
        "params": "⚙️ Параметры",
        ...
        "max_alt": "Макс. высота",
        "min_alt": "Мин. высота",
        "celestrak": "📡 Данные Celestrak",
        "group": "Группа",
        "alert_latency": "⚠️ Высокая задержка!",
        "alert_satellites": "⚠️ Мало активных спутников!",
        "alert_threshold": "Порог (мс)",
        "active_threshold": "Мин. спутников",
        "3d_globe": "🌍 3D-глобус",
        "pricing": "💰 Цены",
        "coverage": "📡 Покрытие",
        "spectrum": "📶 6G-спектр",
...
with st.sidebar:
    ...
    if st.session_state.get('auto_refresh', False):
        st.success(f"🔄 التحديث التلقائي نشط (كل
