...
# ============================================================
# ⏱️ نظام التحديث التلقائي المداري (Auto-Refresh) المسترجع
# ============================================================
...
# ============================================================
# 💰 خطط الاشتراك التجاري المسترجعة (Pricing Plans)
# ============================================================
st.markdown("---")
...
# ============================================================
# 📊 تصدير التقارير الرسمية والسيادية المسترجعة (Export Section)
# ============================================================
st.markdown("---")
...
# ============================================================
# 🛰️ إدارة المحطات الأرضية بدقة جغرافية مطابقة تماماً للموقع
# ============================================================
st.subheader(t('ground_station'))
...
if gs_input_name in predefined_stations:
    ...
    col_l1, col_l2 = st.columns(2)
    with col_l1:
        gs_lat = st.number_input(t('gs_lat'), -90.0, 90.0, 28.6139)
    with col_l2:
        gs_lon = st.number_input(t('gs_lon'), -180.0, 180.0, 77.2090)
    gs_choice = gs_input_name
...
# ============================================================
# 📈 إعادة إدراج الرسم البياني الزمني (Latency Chart) بدقة عالية
# ============================================================
st.markdown("---")
st.subheader(t('latency_chart'))
...
# ============================================================
# 🌍 الخريطة 3D (مع تصحيح موقع المحطة لتطابق تام)
# ============================================================
def render_cosmic_globe(df, gs_lat, gs_lon, station_name, title="🌍 3D Constellation Globe"):
    fig = go.Figure()
    fig.update_layout(
